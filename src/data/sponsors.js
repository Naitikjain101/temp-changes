export const sponsors = {
  sponsors: [
    ...
    { name: 'Duality', logo: '/sponsors/duality.jpg', website: 'https://www.duality.ai/', description: 'Food and beverage partner.' },
    { name: 'Microsoft Azure Community', logo: '/sponsors/microsoftazure.jpg', website: '#', description: 'Web3 and blockchain ecosystem.' },
    { name: 'InterviewBudyy', logo: '/sponsors/interviewbuddy.png', website: 'https://interviewbuddy.net/?srsltid=AfmBOopNZkpNZ5HjaWjVW_sgkEKL7KoGl6cd4kYC9rcYqrlGfTYPV4su', description: 'Financial literacy and support.' },
